...
local function CreateTestIcon()
    ...
    frameSample = CreateFrame("Frame", nil, frameContainer)
    frameSample:SetPoint("TOPRIGHT", frameContainer, "TOPRIGHT", -10, -10)
...
function addon:GetGeneralSettings(parent)
    frameContainer = CreateFrame("Frame", nil, parent)

    SettingsDB.bindingFontSize = SettingsDB.bindingFontSize or 12

    local showGlobalSweep = addon:GetControlCheckbox(false, "Show GCD Sweep", frameContainer, function(control)
        SettingsDB.showGlobalSweep = control:GetChecked()
    end)
    showGlobalSweep:SetPoint("TOPLEFT", frameContainer, "TOPLEFT", 10, -10)
    ...
    local textFont = addon:GetControlLabel(false, frameContainer, "Font:", 60)
    textFont:SetPoint("TOPLEFT", isLocked, "BOTTOMLEFT", 0, -10)

    local dropdownFont = addon:GetControlDropdown(false, frameContainer, 120)
    ...
    local textBindingLabel = addon:GetControlLabel(false, frameContainer, "   Bind:", 60)
    textBindingLabel:SetPoint("TOPLEFT", textFont, "BOTTOMLEFT", 0, -10)

    local textBindingFontSize = addon:GetControlLabel(false, frameContainer, "Size", 30)
    ...
    local textBindingFontFlags = addon:GetControlLabel(false, frameContainer, "Flags", 40)
    textBindingFontFlags:SetPoint("LEFT", inputBinding, "RIGHT", 10, 0)

    local dropdownBinding = addon:GetControlDropdown(false, frameContainer, 120)
    ...
    local checkboxBinding = addon:GetControlCheckbox(false, "Shadow", frameContainer, function(control)
    ...
    local textChargesLabel = addon:GetControlLabel(false, frameContainer, "   Stack:", 60)
    textChargesLabel:SetPoint("TOPLEFT", textBindingLabel, "BOTTOMLEFT", 0, -10)

    local textChargesFontSize = addon:GetControlLabel(false, frameContainer, "Size", 30)
    ...
    local textChargesFontFlags = addon:GetControlLabel(false, frameContainer, "Flags", 40)
    textChargesFontFlags:SetPoint("LEFT", inputCharges, "RIGHT", 10, 0)

    local dropdownCharges = addon:GetControlDropdown(false, frameContainer, 120)
    ...
    local checkboxCharges = addon:GetControlCheckbox(false, "Shadow", frameContainer, function(control)
    ...
    local textCooldownLabel = addon:GetControlLabel(false, frameContainer, "   CD:", 60)
    textCooldownLabel:SetPoint("TOPLEFT", textChargesLabel, "BOTTOMLEFT", 0, -10)

    local textCooldownFontSize = addon:GetControlLabel(false, frameContainer, "Size", 30)
    ...
    local textCooldownFontFlags = addon:GetControlLabel(false, frameContainer, "Flags", 40)
    textCooldownFontFlags:SetPoint("LEFT", inputCooldown, "RIGHT", 10, 0)

    local dropdownCooldown = addon:GetControlDropdown(false, frameContainer, 120)
    ...
    local checkboxCooldown = addon:GetControlCheckbox(false, "Shadow", frameContainer, function(control)
    ...
    local textRankLabel = addon:GetControlLabel(false, frameContainer, "   Rank:", 60)
    textRankLabel:SetPoint("TOPLEFT", textCooldownLabel, "BOTTOMLEFT", 0, -10)

    local textRankFontSize = addon:GetControlLabel(false, frameContainer, "Size", 30)
    ...
    local textRankFontFlags = addon:GetControlLabel(false, frameContainer, "Flags", 40)
    textRankFontFlags:SetPoint("LEFT", inputRank, "RIGHT", 10, 0)

    local dropdownRank = addon:GetControlDropdown(false, frameContainer, 120)
    ...
    local checkboxRank = addon:GetControlCheckbox(false, "Shadow", frameContainer, function(control)
